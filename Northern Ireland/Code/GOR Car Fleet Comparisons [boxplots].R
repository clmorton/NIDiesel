...
ggplot(GOR_Comparison, aes(x=Region, y=PropDiesel)) + geom_boxplot() theme(axis.text.x=element_text(angle=30, vjust=0.8, hjust=1, face="bold"))
ggbox <- ggplot(GOR_Comparison, aes(x=Region, y=PropDiesel)) + geom_boxplot(outlier.shape = NA)
ggbox <- ggbox + theme(axis.text.x=element_text(color = "black", angle=30, vjust=0.8, hjust=1, size=12))
...
ggplot(GOR_Comparison, aes(x=Region, y=PropCompanyCar)) + geom_boxplot() theme(axis.text.x=element_text(angle=30, vjust=0.8, hjust=1, face="bold"))
...
ggplot(GOR_Comparison, aes(x=Region, y=Cars..Average.Age)) + geom_boxplot() theme(axis.text.x=element_text(angle=30, vjust=0.8, hjust=1, face="bold"))
...
ggplot(GOR_Comparison, aes(x=Region, y=Cars..Av.Mass)) + geom_boxplot() theme(axis.text.x=element_text(angle=30, vjust=0.8, hjust=1, face="bold"))
...
ggplot(GOR_Comparison, aes(x=Region, y=Cars..Av.Engine.Size)) + geom_boxplot() theme(axis.text.x=element_text(angle=30, vjust=0.8, hjust=1, face="bold"))
